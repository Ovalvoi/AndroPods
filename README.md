...
A lightweight AirPods companion for Android, built for **AirPods (2nd generation, 2019)** — A2031/A2032, case A1602/A1938 — on a Pixel 7.

Shows left, right and case battery, and raises a quiet notification when you open the case. Kotlin, Jetpack Compose, Material You dynamic colour.
...
./gradlew testDebugUnitTest    # 37 unit tests
...
Unit tests cover the parser and the tracker, including left/right transposition, the inverted lid bit, the `0xF` unknown sentinel, the Find My eviction trap, anti-flapping under RSSI jitter, rejection of the 15-byte connected frame and of non-Gen-2 models, and one frame captured from the real pair (37 tests).
